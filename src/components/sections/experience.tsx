  ...
  >
    ...
    <div className="pt-10 768:px-20 768:pt-20 768:pb-20 flex flex-col gap-8">
      <ExperienceCard
        ...
        subtitle="Chello, Charlotte NC"
        textContent={[
          <p key="exp 4 sentence 1">
            Designed and build an internal tool to display customer information
            directly from our databases. This allowed the business team to more
            quickly and reliably interact with customers without needing the
            technical know-how of parsing the databases.
          </p>,
        ]}
      />
      <ExperienceCard
